...
def render_sample_data(
        ...
        ax=None,
        nsweeps: int = 1,
        out_path: str = 'test/temp_maptr/Mon_Jul_31_15_23_24_2023/pts_bbox_obj/plots',
...
if __name__ == '__main__':
    ...
    bevformer_results = mmcv.load('/media/motorwala/Daten/Abdulkader_ Thesis/val/work_dirs/perception/Wed_Aug__9_12_48_22_2023/pts_bbox_obj/results_nusc.json')
    # print(type(bevformer_results1['results']['cc18fde20db74d30825b0b60ec511b7b']))
    # bevformer_results2 = mmcv.load('test1/temp_maptr/f1/pts_bbox/nuscmap_results.json')
    # print(bevformer_results2['results'][1]['vectors'])
    sample_token_list = list(bevformer_results['results'].keys())
    # sample_token_list = list(bevformer_results['results'])
