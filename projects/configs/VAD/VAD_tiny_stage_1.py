...
model = dict(
    ...
    pts_bbox_head=dict(
        ...
        loss_map_pts=dict(type='PtsL1Loss', loss_weight=5.0),
...
train_pipeline = [
    ...
    dict(type='CustomCollect3D',\
         keys=['gt_bboxes_3d', 'gt_labels_3d', 'img', 'points', 'ego_his_trajs',
...
evaluation = dict(interval=4, pipeline=test_pipeline, metric='bbox', map_metric='chamfer')
