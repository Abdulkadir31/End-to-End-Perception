...
model = dict(
    ...
    pts_bbox_head=dict(
        ...
        bbox_coder=dict(
            ...
            voxel_size=voxel_size,
            num_classes=num_map_classes),
        bbox_coder_traj=dict(
            type='TrajTRNMSFreeCoder',
            post_center_range=[-20, -35, -20, -35, 20, 35, 20, 35],
            pc_range=point_cloud_range,
            max_num=50,
            voxel_size=voxel_size,
    ...
    train_cfg=dict(pts=dict(
        ...
        assigner_obj=dict(
            ...
            cls_cost=dict(type='FocalLossCost', weight=2.25),
        ...
        assigner=dict(
            ...
            # reg_cost=dict(type='BBoxL1Cost', weight=0.25, box_format='xywh'),
...
log_config = dict(
    ...
    hooks=[
        ...
        dict(type='WandbLoggerHook', init_kwargs={'project':'Fusion'})
    ])
